 ...
 * Description: Handles Registrations for Sports Events with Third Party Payment Processors (Decidir, Dineromail, CuentaDigital, EasyPlanners, etc). </br> <strong>After Install:</strong> </br> </br> -Change the permalink structure to "Post name" (Settings->Permalinks->Post Name) </br> -Install "Responsive" theme. (Appearence->Themes->Add New) </br> -Set your timezone. (Settings->General->Timezone) </br> -Install "Really Simple CAPTCHA" plugin </br> -Install "Disable Comments" plugin, then setup propertly </br> -Install "WP Maintenance Mode" plugin - AND EXCLUDE Dineromail endpoint "post_dm_ipn" this way you will be able to get POSTs during maintenance.</br> -Install "Language Switcher" plugin (zip file included inside sigma plugin package) </br> -Setup DB parameters in this file "cron-config.php", otherwise CSV to DB will not work </br> -Set "CSV to Database" cron job from Cpanel, for details see under "Dashboard"->"CSV to DB" </br> -Install "Debug Bar" and "Debug Bar Console" plugins, for usage details see under "Dashboard"->"CSV to DB"
 * Version: 4.4.2
 * Author: SigmaSystems
